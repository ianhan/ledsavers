...
class PanelApp:
    ...
    def _randomize_fluere_palette(self) -> None:
        ...
        self.fluere_color_table = get_color_table(
            palette=palette,
            rng=palette_rng,
    ...
    def _advance_fluere(self) -> None:
        ...
        self.fluere_palette_offset = (self.fluere_palette_offset + PALETTE_CYCLE_STEP) % PALETTE_SIZE
    ...
    def _setup_terminal_controls(self) -> None:
        ...
        print("Terminal controls: m=new map, p=next palette, q=quit", file=sys.stderr)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Display additive RGB Life worlds with phosphor decay, optional Fluere dead-space background, and four random worms per active color.",
    )
